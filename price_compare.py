...
for file in file_list:
    ...
    #print(status)
    for rcvd_row in ws_agile_rcvd.iter_rows(min_row=1,max_row=ws_agile_rcvd.max_row+1,min_col=1,max_col=ws_agile_rcvd.max_column+1,values_only=True):
...
for rcvd_row in ws_agile_rcvd_full.iter_rows(min_row=0,max_row=ws_agile_rcvd_full.max_row+1,min_col=0,max_col=ws_agile_rcvd_full.max_column+1,values_only=True):
